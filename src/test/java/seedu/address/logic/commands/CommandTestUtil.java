...
public class CommandTestUtil {
    ...
    public static final String PHONE_DESC_AMY = " " + PREFIX_AMOUNT + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + PREFIX_AMOUNT + VALID_PHONE_BOB;
    public static final String EMAIL_DESC_AMY = " " + PREFIX_DATE + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_DATE + VALID_EMAIL_BOB;
    ...
    public static final String INVALID_PHONE_DESC = " " + PREFIX_AMOUNT + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_DATE + "bob!yahoo"; // missing '@' symbol
